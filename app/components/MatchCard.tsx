        ...
        <div className="flex flex-col xl:flex-row gap-4 sm:gap-6 pt-6 xl:pt-0">
          ...
          <div className="flex-1 space-y-5">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 text-sm text-white/50 mb-5">
              ...
              {isUpcoming && (
                <div className="mb-5 p-3 sm:p-4 rounded-xl bg-white/[0.02] border border-white/5">
